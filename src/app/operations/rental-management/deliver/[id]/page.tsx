  ...
  return (
    <main className="min-h-screen px-4 py-8">
      <section className="mx-auto max-w-xl rounded-3xl border border-white bg-white/95 p-5 shadow-soft">
        <p className="text-xs font-extrabold uppercase tracking-wide text-cyan-700">Confirm Delivered</p>
...
export default async function ConfirmRentalDeliveryPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <RentalManagementClient authContext={auth.context} mode="deliver" pendingRentalId={id} />;
}
